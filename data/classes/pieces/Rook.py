...
class Rook(Piece):
	...
	def get_possible_moves(self, board):
		...
		Returns a list of lists of Square objects, where each list of Square objects represents a possible direction of movements for the Rook.
		Example:
		[
		...
		"""
		# TODO: The Rook can move any number of squares in a straight line, horizontally or vertically.
		output = []
		return output
